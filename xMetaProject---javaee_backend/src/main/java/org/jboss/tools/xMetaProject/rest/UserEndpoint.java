...
public class UserEndpoint
{
   ...
   {
      TypedQuery<User> findByIdQuery = em.createQuery("SELECT DISTINCT u FROM User u LEFT JOIN FETCH u.metaProject WHERE u.id = :entityId ORDER BY u.id", User.class);
   ...
   {
      TypedQuery<User> findAllQuery = em.createQuery("SELECT DISTINCT u FROM User u LEFT JOIN FETCH u.metaProject ORDER BY u.id", User.class);
